      ...
      <div className="flex w-full cursor-pointer flex-col items-center justify-center">
        ...
        <div className="w-full flex flex-col items-center justify-start gap-2 ">
          ...
          <div className="flex justify-between items-center w-full">
            <h1 className="text-[#1D3557] text-2xl py-1 font-black">
              &#9734; Group info {"-->"}{" "}
            </h1>
          ...
          currentUser?.map((user, idx) => {
            ...
            return (
              <div
                ...
                key={idx}
                className={`${
                  isSelected ? "bg-[#1e2939a3] " : "bg-[#28AFB0]"
                } border-2 h-16 py-2 cursor-pointer w-full flex justify-between items-center px-2 rounded-2xl`}
              >
                <div className="h-full items-center justify-between w-full flex text-[#1D3557]">
                  <div className="h-full items-center flex-wrap flex gap-4">
                    ...
                    <div className="flex flex-col items-start ">
                      ...
                      <h4 className="italic text-gray-700 ">@{user.username}</h4>
                    </div>
                  </div>
                  {isSelected ? (
