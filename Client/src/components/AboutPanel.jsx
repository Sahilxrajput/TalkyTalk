  ...
  const exitChatHandler = async () => {
    ...
    try {
      const response = await axios.put(
        ...
        { userIds: user._id, chatId: chatTitle._id },
        { withCredentials: true }
      );
  ...
  return (
    <div className="flex flex-col justify-start p-2 pt-0 gap-1 items-center">
      ...
      <button
        ...
        className="cursor-pointer hover:bg-[#28afb0] text-[#457b9d] hover:text-white transition-colors duration-300 ease-in flex justify-center gap-2 items-center border-1 py-2 w-full rounded-xl"
      >
